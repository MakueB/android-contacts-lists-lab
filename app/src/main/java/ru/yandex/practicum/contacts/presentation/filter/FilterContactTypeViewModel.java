...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        ...
        ArrayList<FilterContactTypeUi>filterContactTypeUiArrayList= new ArrayList<>();
        filterContactTypeUiArrayList.add(createAllSelectedItem(contactType));

        for(String type: contactType){
            FilterContactTypeUi filterContactTypeUi = createFilterContactType(type);
            filterContactTypeUiArrayList.add(filterContactTypeUi);
        }

        filterContactTypesLiveDate.setValue(filterContactTypeUiArrayList);
    }
